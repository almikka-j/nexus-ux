      ...
      <Box
        sx={{
          ...
          backgroundImage: {
            ...
            md: 'url("/images/loan/fast-loan-banner.png") ',
          },
      ...
      >
        <Container sx={{ maxWidth: '1280px !important' }}>
          <Box textAlign={{ xs: 'center', md: 'left' }} pl={{ md: 10 }}>
            <LoanType primary="FAST" secondary="LOAN" />
            <Typography variant="h2" sx={{ fontWeight: 'bold', lineHeight: 1, my: 1.5 }}>
              Funding That Moves
              <br /> at Your Speed
            </Typography>
            <Typography variant="body1" sx={{ maxWidth: 460, mx: { xs: 'auto', md: 0 } }}>
              Designed for urgent neeeds, our Fast Loan delivers secured support&mdash;efficiently
              and reliably.
            </Typography>
            <Button
              variant="text"
              sx={{ mt: 3, color: 'white', px: 0, ':hover': { px: 1 } }}
              startIcon={<Iconify icon="mdi:arrow-right" />}
            >
              Apply now for fast-track approval
            </Button>
          </Box>
        </Container>
      </Box>
          ...
          <Grid item xs={12} md={6}>
            ...
            <Box mb={4}>
              ...
              <Box component="ul" sx={{ listStyleType: 'disc' }}>
                {personalLoanDetails?.fastloanRequiredDocuments.map((item, index) =>
