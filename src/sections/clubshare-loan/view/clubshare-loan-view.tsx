...
import { FAQList3 } from 'src/sections/faq/faq-list';
import LoanCalculatorClubshare from 'src/sections/home/loan-calculator-clubshare';

// ----------------------------------------------------------------------

export function ClubshareLoanView() {
      ...
      <Box
        sx={{
          ...
          backgroundImage: {
            ...
            md: 'url("/images/loan/clubshare.png")',
          },
      ...
      >
        <Container sx={{ maxWidth: '1280px !important' }}>
          <Box textAlign={{ xs: 'center', md: 'left' }} pl={{ md: 10 }}>
            <Box
              component="img"
              src="/images/loan/clubsharelogo.png"
              alt="Clubshare Loan"
              sx={{
                width: '100%',
                maxWidth: 80,
            ...
            />
            <LoanType primary="CLUBSHARE" secondary="LOAN" />
            <Typography variant="h2" sx={{ fontWeight: 'bold', lineHeight: 1, my: 1.5 }}>
              Privileges that
              <br /> expand your lifestyle
            </Typography>
            <Typography variant="body1" sx={{ maxWidth: 460, mx: { xs: 'auto', md: 0 } }}>
              Club membership unlocks access to an exclusive loan benefit, reserved exclusively for members.
            </Typography>
            <Button
              component="a"
          ...
          <Grid item xs={12} md={6}>
            ...
            <Box mb={4}>
              ...
              <Box component="ul" sx={{ listStyleType: 'disc' }}>
                {personalLoanDetails?.clubshareRequiredDocuments.map((item, index) =>
