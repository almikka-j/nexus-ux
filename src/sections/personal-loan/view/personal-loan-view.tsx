...
export function PersonalLoanView() {
      ...
      <Box
        sx={{
          ...
          backgroundImage: {
            ...
            md: 'url("/images/loan/personal-loan-banner.png")',
          },
      ...
      >
        <Container sx={{ maxWidth: '1280px !important' }}>
          <Box textAlign={{ xs: 'center', md: 'left' }} pl={{ md: 10 }}>
            <LoanType primary="PERSONAL" secondary="LOAN" />
            <Typography variant="h2" sx={{ fontWeight: 'bold', lineHeight: 1, my: 1.5 }}>
              Make Room
              <br /> for Possibilities
            </Typography>
            <Typography variant="body1" sx={{ maxWidth: 460, mx: { xs: 'auto', md: 0 } }}>
              Access personal financing backed by your property, so you can say yes to life&apos;s
